    ...
    <main className='page-wrapper page-centered'>
      ...
      <div className='flex gap-6 justify-center'>
        <button
          ...
          className='flex flex-col items-center justify-center gap-3 py-8 px-6 bg-qmint rounded-card cursor-pointer min-w-[140px] max-w-[200px] min-h-[180px] font-body text-qslate transition-all duration-200 hover:scale-105 active:scale-95'
        >
        ...
        <button
          ...
          className='flex flex-col items-center justify-center gap-3 py-8 px-6 bg-qyellow rounded-card cursor-pointer min-w-[140px] max-w-[200px] min-h-[180px] font-body text-qslate transition-all duration-200 hover:scale-105 active:scale-95'
        >
          <div className='text-5xl' aria-hidden='true'>
